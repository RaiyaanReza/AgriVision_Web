        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
            <div className="md:col-span-2">
              <h3 className="text-xl font-black mb-6 tracking-tighter">
                AgriVision Pro
              </h3>
              <p className="text-gray-500 dark:text-gray-400 font-medium max-w-sm leading-relaxed">
                Empowering the next generation of precision agriculture through
                advanced computer vision and agentic AI systems.
              </p>
            </div>
            <div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-12 border-t border-gray-50 dark:border-gray-900">
            ...
            <div className="flex gap-8">
              <a
                href="#"
                className="text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-green-600 transition-colors"
              >
                Privacy Policy
              </a>
              <a
