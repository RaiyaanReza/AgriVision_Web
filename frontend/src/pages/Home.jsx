...
import { ArrowRight, Leaf, Zap, Database, WifiOff, Languages, UserCheck } from 'lucide-react';
    ...
    <div className="overflow-hidden">
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Start detecting crop diseases now with our AI-powered platform. Get instant results and treatment recommendations.
          </motion.p>
          <motion.div
